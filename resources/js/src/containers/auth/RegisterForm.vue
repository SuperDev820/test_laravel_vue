...
<script>
    ...
    export default {
        ...
        mixins: [formMixin, AlertService, AxiosService],
        data() {
            return {
                name: null,
                boolean: false,
        ...
        methods: {
            async register() {
                if (!this.boolean) {
                    await this.AlertShow("warning", "You need to agree with our terms and conditions.")
                    return;
                }
                let instance = this;
                this.post('register', {
                    ...
                    function (error) {
                        instance.AlertShow("warning", error.data.message);
                });
            },
            registerSuccess() {
                this.redirect("/home")
